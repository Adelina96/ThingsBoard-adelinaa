...
export class TestingComponent extends EntityComponent<TestingInfo> {
    ...
    return this.fb.group(
      {
        ...
        cameraType: [entity ? entity.cameraType : '', [Validators.required]],
        model: [entity ? entity.model : '', [Validators.required]],
        ip: [entity ? entity.ip : '', [Validators.required]],
  ...
  updateForm(entity: Testing) {
    ...
    this.entityForm.patchValue({cameraType: entity.cameraType});
    this.entityForm.patchValue({model: entity.model});
    this.entityForm.patchValue({ip: entity.ip});
